...
dataset_dict = dict(
    ...
    depthtrack_train=DatasetInfo(module=pt % "depthtrack_train", class_name="DepthTrack_Train_Dataset", kwargs=dict(dtype='rgbcolormap')),
    votrgbd22=DatasetInfo(module=pt % "votrgbd22", class_name="VOTRGBD22Dataset", kwargs=dict(dtype='rgbcolormap')),
