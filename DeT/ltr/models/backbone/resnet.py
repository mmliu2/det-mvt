...
# from torchvision.models.resnet import model_urls # TODO model_urls not available
...
def resnet18(output_layers=None, pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        model.load_state_dict(load_state_dict_from_url(resnet50_url))
    return model
    ...
    if pretrained:
        ...
        if pretrained_path is not None:
            if pretrained_path[0]:
                ...
                pretrained_model_rgb = load_state_dict_from_url(resnet50_url)
            ...
            if pretrained_path[1]:
                ...
                pretrained_model_depth = load_state_dict_from_url(resnet50_url)
        else:
            # pretrained_model_rgb = model_zoo.load_url(model_urls['resnet50'])
            pretrained_model_rgb = load_state_dict_from_url(resnet50_url)
            # pretrained_model_depth = model_zoo.load_url(model_urls['resnet50'])
