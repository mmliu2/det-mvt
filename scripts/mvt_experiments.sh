...
# # python run_training.py mvt DeT_MVT_Max_KD002_CRD002
# # baselines
...
# # baselines
# python pytracking/run_tracker.py mvt DeT_DiMP50_Max_original_test --dataset_name depthtrack --input_dtype rgbcolormap --threads 4
# python pytracking/run_tracker.py mvt DeT_DiMP50_Max --dataset_name depthtrack --input_dtype rgbcolormap --threads 4
...
# baselines
python pytracking/run_tracker.py mvt DeT_DiMP50_Max_original_test --dataset_name votrgbd22 --input_dtype rgbcolormap --threads 4
python pytracking/run_tracker.py mvt DeT_DiMP50_Max --dataset_name votrgbd22 --input_dtype rgbcolormap --threads 4
